...
func init() {
  ...
  rootCmd.Flags().StringArrayVarP(&excludeFlag, "exclude", "e", []string{}, "Exclude files matching glob patterns (can be specified multiple times)")
}
